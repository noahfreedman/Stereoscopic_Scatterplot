...
private var x = 0.0;
private var y = 0.0;
public var mouseButtonNumber = 0;

private var  cameraDistanceMax = 6f;
private var  cameraDistanceMin = 0.7f;
...
function LateUpdate () {
	if (target && Input.GetMouseButton(mouseButtonNumber)) {
